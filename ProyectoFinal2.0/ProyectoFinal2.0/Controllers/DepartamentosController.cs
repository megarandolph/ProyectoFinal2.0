...
namespace ProyectoFinal2._0.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "departamentoId,dep_codigo,nombre")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "departamentoId,dep_codigo,nombre")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
